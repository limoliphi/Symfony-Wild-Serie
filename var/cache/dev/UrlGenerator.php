...
return [
    ...
    'home_index' => [[], ['_controller' => 'App\\Controller\\DefaultController::index'], [], [['text', '/']], [], []],
    ...
    'app_profile' => [[], ['_controller' => 'App\\Controller\\SecurityController::profile'], [], [['text', '/my-profile']], [], []],
    ...
    'wild_episode' => [['slug'], ['_controller' => 'App\\Controller\\WildController::showEpisode'], [], [['variable', '/', '[^/]++', 'slug', true], ['text', '/wild/episode']], [], []],
    'wild_actor' => [['slug'], ['_controller' => 'App\\Controller\\WildController::showActor'], [], [['variable', '/', '[^/]++', 'slug', true], ['text', '/wild/actor']], [], []],
