...
class __TwigTemplate_ad46bfa18bacb6c7059d31ba322fd2c6ffaf7a52bafdee4fbb4f761c7e9bb2af extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/home/wilder/PhpstormProjects/wild-series/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}
