...
/* wild/show.html.twig */
class __TwigTemplate_acbbb983e7b5a1245163fbaf01668db2ce2621934709bb9002471831f2466265 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["season"]) {
            ...
            echo "\">
                        <button type=\"button\" class=\"btn btn-outline-danger\">Découvrez la
                            saison ";
            // line 19
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["season"], "id", [], "any", false, false, false, 19), "html", null, true);
            echo "</button>
                    </a>
                ";
        }
