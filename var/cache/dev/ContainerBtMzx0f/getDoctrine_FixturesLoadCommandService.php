...
include_once $this->targetDirs[3].'/src/DataFixtures/ActorFixtures.php';
...
include_once $this->targetDirs[3].'/src/DataFixtures/EpisodeFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/ProgramFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/SeasonFixtures.php';
...
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\ActorFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\EpisodeFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\ProgramFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\SeasonFixtures(), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\UserFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []]]);
